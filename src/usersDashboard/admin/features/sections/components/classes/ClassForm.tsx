...
// import { Plus, Tag, Hash, Layers } from "lucide-react";
...
//             <input type="text" placeholder="e.g. Junior Secondary School One" disabled={addClass.isPending}
...
//             <input type="text" maxLength={8} placeholder="E.G. JSS 1" disabled={addClass.isPending}
...
//         <div>
//           <label className="block text-sm font-medium text-label mb-1.5">Section ID *</label>
//           <div className="relative">
//             <Layers size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-text-muted" />
//             <input type="text" placeholder="Copy ID from Sections table" disabled={addClass.isPending}
//               className="w-full pl-8 pr-3 py-2.5 text-sm rounded-lg border border-border-line02 bg-bg-input outline-none focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary transition-all"
//               {...register("section")} />
//           </div>
//           {errors.section && <p className="mt-1 text-xs text-danger">{errors.section.message}</p>}
//           {/* TODO: replace with FormSelect dropdown once GET /sections/sections/ is wired */}
//         </div>
    ...
    <div className="bg-white rounded-2xl card-shadow p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
        ...
        <FormSelect
          ...
          isLoading={addClass.isPending || sectionsLoading}
          options={sectionOptions}
          placeholder={sectionsLoading ? "Loading sections..." : "Select a section"}
          {...register("section")}
        />
