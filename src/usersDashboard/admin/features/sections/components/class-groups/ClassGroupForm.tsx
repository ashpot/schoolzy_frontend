  ...
  return (
    <div className="bg-white rounded-2xl card-shadow p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
        ...
        <FormSelect label="Parent Class *" error={errors.parentClass?.message} isLoading={addGroup.isPending}
          options={classSelectOptions} placeholder="Select parent class" {...register("parentClass")} />
