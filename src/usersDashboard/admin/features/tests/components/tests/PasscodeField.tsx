  ...
  return (
    <div>
      ...
      <div className={`flex items-center gap-2 px-3 py-2.5 rounded-xl border bg-bg-input transition-all ${
        error
          ? "border-danger"
          : "border-border-line02 focus-within:ring-2 focus-within:ring-brand-primary/20 focus-within:border-brand-primary"
      }`}>
        ...
        <input
          ...
          disabled={isLoading}
          className="flex-1 bg-transparent text-sm text-text-primary focus:outline-none min-w-0 disabled:opacity-60"
        />
        <div className="flex items-center gap-0.5 shrink-0">
          <button
            ...
            className="w-7 h-7 rounded-lg flex-center text-text-muted hover:text-text-nav hover:bg-gray-100 transition-colors"
          >
          ...
          <button
            ...
            disabled={isLoading}
            title="Regenerate"
            className="w-7 h-7 rounded-lg flex-center text-brand-primary hover:bg-blue-50 transition-colors disabled:opacity-50"
          >
