...
// /**
//  * A reusable form input that:
//  * - Forwards ref for React Hook Form’s register
//  * - Shows an accessible label
//  * - Displays error messages
//  * - Supports a loading/disabled state
//  */
// const FormInput = forwardRef<HTMLInputElement, FormInputProps>(
//   ({ label, name, error, isLoading, className = '', ...props }, ref) => {
//     return (
