...
import { DashboardIcon, ProfileUsers, LearningIcon, ResultsIcon } from "@/shared/lib/SvgLib";

const TEACHER_ROOT_ROUTE = "teacher-dashboard";

export const teacherNavItems: NavItem[] = [
  { id: "dashboard", label: "Dashboard", path: `/${TEACHER_ROOT_ROUTE}`, icon: DashboardIcon },
  {
    id: "my-classes",
    label: "My Classes",
    ...
    icon: ProfileUsers,
    children: [
      { id: "class-list", label: "Class List", path: `/${TEACHER_ROOT_ROUTE}/my-classes/class-list`, icon: ProfileUsers },
      { id: "attendance-summary", label: "Attendance Summary", path: `/${TEACHER_ROOT_ROUTE}/my-classes/attendance-summary`, icon: ProfileUsers },
    ],
  },
  {
    id: "learning",
