...
import { DashboardIcon, ProfileUsers, ResultsIcon, FinancesIcon } from "@/shared/lib/SvgLib";

const STUDENT_ROOT_ROUTE = "student-dashboard";

export const studentNavItems: NavItem[] = [
  { id: "dashboard", label: "Dashboard", path: `/${STUDENT_ROOT_ROUTE}`, icon: DashboardIcon },
  { id: "my-class", label: "My Class", path: `/${STUDENT_ROOT_ROUTE}/my-class`, icon: ProfileUsers },
