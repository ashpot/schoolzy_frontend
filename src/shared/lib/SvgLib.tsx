...
export const BrandIcon: FC<svgProps> = ({ className, stroke = 'currentColor' }) => (
...
export const LoginIcon: FC<svgProps> = ({ className, stroke = 'currentColor' }) => (
...
const LazyIcon = (importer: () => Promise<{ default: FC<svgProps> }>) => {
  const Component = lazy(importer);
  const Wrapped: FC<svgProps> = (props) => (
    <Suspense fallback={<span className="w-5 h-5 shrink-0 bg-border-line02 rounded animate-pulse" />}>
      <Component {...props} />
    </Suspense>
  );
  return Wrapped;
...
export const ProfileUsers   = LazyIcon(() => import("@/shared/lib/icons/ProfileUsers"));
export const AcademicsIcon  = LazyIcon(() => import("./icons/AcademicsIcon"));
export const LearningIcon   = LazyIcon(() => import("./icons/LearningIcon"));
export const TestsIcon      = LazyIcon(() => import("./icons/TestsIcon"));
export const ResultsIcon    = LazyIcon(() => import("./icons/ResultsIcon"));
export const SectionsIcon   = LazyIcon(() => import("./icons/SectionsIcon"));
export const FinancesIcon   = LazyIcon(() => import("./icons/FinancesIcon"));
export const InventoryIcon  = LazyIcon(() => import("./icons/InventoryIcon"));
export const SessionsIcon   = LazyIcon(() => import("./icons/SessionsIcon"));
export const SettingsIcon   = LazyIcon(() => import("./icons/SettingsIcon"));
export const MessageIcon   = LazyIcon(() => import("@/shared/lib/icons/MessageSquare"));
export const BellIcon   = LazyIcon(() => import("@/shared/lib/icons/NotificationBell"));
