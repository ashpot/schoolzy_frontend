...
// ---- Re‑export Lucide icons as named exports ----
export {
  LayoutDashboard as DashboardIcon,
  Users as ProfileUsers,
  GraduationCap as AcademicsIcon,
  BookOpen as LearningIcon,
  ClipboardCheck as TestsIcon,
  FileText as ResultsIcon,
  Grid3X3 as SectionsIcon,
  DollarSign as FinancesIcon,
