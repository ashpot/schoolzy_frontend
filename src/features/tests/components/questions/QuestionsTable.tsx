    ...
    <div className="bg-white rounded-2xl card-shadow overflow-hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-8 pr-4 py-1.5 rounded-lg border border-[var(--color-border-line02)] bg-[var(--color-bg-input)] text-xs text-[var(--color-text-primary)] placeholder:text-[var(--color-text-muted)] focus:outline-none focus:ring-2 focus:ring-[var(--color-brand-primary)]/20 focus:border-[var(--color-brand-primary)] transition-all w-44"
            />
          </div>
          ...
          >
            {filtered.map((q, idx) => (
              ...
              >
                ...
                <td className="px-4 py-4 text-sm text-[var(--color-text-secondary)] max-w-[220px]">
                  <p className="truncate">{q.questionText}</p>
                </td>
                <td className="px-4 py-4">
                  <QuestionTypeBadge type={q.type} />
                </td>
                <td className="px-4 py-4 text-sm text-[var(--color-text-muted)] max-w-[180px]">
      ...
      {filtered.length === 0 && (
        <div className="py-14 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-sm font-semibold text-[var(--color-text-nav)]">
            No questions found
          </p>
